export const environment = {
  production: false,
  urlBackend: 'https://rutasbackend.azurewebsites.net',
  ...
  urlProveedores: 'https://proveedoresbackend.azurewebsites.net', // Url de qa - Debe reemplazarse por la de produccion
